...
In the following, we consider neural \acrshort{OT} solvers that make direct use of the \nameref{thm:brenier} and are based on the semi-dual \eqref{eq:dual-cvx}. For a review of alternative approaches, see \cref{sec:other_neural_solvers}.
...
Due to the high dimensional nature of \acrshort{sc}\acrshort{RNAseq} data, we apply $\textsc{CellOT}$ on latent representations learned by an autoencoder.
