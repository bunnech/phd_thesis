...
The advantage of such methods is that they generalize to all cost functions $c$ and are note restricted to the squared Euclidean distance.
...
For this, each input convex neural networks \citep{amos2017input} is trained with loss functions \eqref{eq:makkuva_f_loss}-\eqref{eq:makkuva_f_loss}. We recover the optimal map $T_k$ using the gradient of this convex function $\varphi_k$, i.e., $\nabla \varphi_k$.
