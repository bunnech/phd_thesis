...
The mathematical foundation of this work thereby builds on the intuition that perturbations incrementally alter the molecular profiles of cells. This underlying assumption aligns with the theory of \acrfull{OT} and \colcircle{darkblue} serves naturally as an inductive bias of the deep learning architectures introduced in this thesis.
...
This thesis is thus concerned with the development of so-called  \colcircle{blue} \textbf{neural optimal transport} that will allow for out-of-sample \emph{predictions} on unseen cell samples and \emph{forecasting} of cellular dynamics \citep{makkuva2020optimal, tong2020trajectorynet,  korotin2021wasserstein, bunne2022proximal, bunne2022supervised, bunne2021learning}. \\

Optimal transport thereby comes in many different flavors.
... \\
