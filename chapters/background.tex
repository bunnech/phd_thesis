...
Gradient flows, or steepest descent curves, are a very classical topic when modeling the evolution of dynamical systems.
...
Considering a functionals $F$ that take a measure or population as input, a gradient flow of $\mu$ w.r.t. to $F$ can be similarly expressed through forward and backward schemes. The forward scheme thereby reads
\begin{equation*}
	...
\end{equation*}
...
...
In recent works, \acrshort{JKO} flows have found application in inferring the evolution of populations over time, crucial in many scientific disciplines when for instance, observing a population of cells in biology \citep{bunne2022proximal, alvarez2021optimizing, mokrov2021large, benamou2016augmented}, which we will discuss in \cref{cha:neural_pde}.
