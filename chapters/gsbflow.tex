...
In this thesis, we consider the likelihood training framework by \citet{chen2021likelihood} grounded on forward-backward \acrshort{SDE} theory \citep{ma1999forward, exarchos2018stochastic}. Crucially, these SDEs can be used to construct the likelihood objectives for \acrshortpl{SB} that, surprisingly, generalize the ones for \acrshort{SGM} as special cases. The negative likelihood function for $\paramf$ and $\paramb$ thereby  are given by
\begin{subequations}
\begin{align}
