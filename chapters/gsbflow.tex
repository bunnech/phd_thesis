...
Similar as in \acrfullpl{SGM} \citep{song2020score, hyvarinen2005estimation} which parameterize the score function, in order to \emph{estimate} the resulting \acrshort{SB} from data, we learn the forward and backward drift through neural networks with parameters $\paramf, \paramb$, i.e., $\SBf$ and $\SBb$. For a visualization of the resulting parameterization, see \cref{fig:principle_dsb}. \\
