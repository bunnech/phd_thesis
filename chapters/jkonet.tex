...
At each time step, the predicted dynamics are compared to the ground truth trajectory $(\mu_0, \mu_1, \dots, \mu_T)$ with the entropy-regularized OT loss (see \ref{eq:reg-ot}),
